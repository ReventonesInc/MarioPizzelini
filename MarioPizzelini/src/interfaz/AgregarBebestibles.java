 ...
 */
public class AgregarBebestibles extends javax.swing.JFrame {

    /**
     * Creates new form AgregarBebestibles
     */
    public AgregarBebestibles() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarBebestibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarBebestibles().setVisible(true);
            }
        });
    }
