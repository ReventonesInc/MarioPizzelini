 ...
 */
public class EliminarBebestible extends javax.swing.JFrame {
    
    private MarioPizzelini empresa;
    private String rut;
    /**
     * Creates new form EliminarBebestible
     */
    public EliminarBebestible(MarioPizzelini empresa, String rut) {
        initComponents();
    ...
    /**
     * Acción para eliminar un bebestible.
     * @param evt 
     */
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        ...
        if(!(id.equals(""))){
            if(empresa.eliminarBebestible(rut, id)){
                JOptionPane.showMessageDialog(null,"¡El bebestible fue eliminado con exito!");
                MenuBebestible frame = new MenuBebestible(empresa, rut);
                frame.setVisible(true);
                this.dispose();
            }
            else{
                JOptionPane.showMessageDialog(null,"¡El bebestible no fue eliminado!");
            }
        }
        else{
