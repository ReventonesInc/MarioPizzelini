...
public class EliminarCliente extends javax.swing.JFrame {
     ...
     */
    public EliminarCliente(MarioPizzelini empresa, String rut) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("ELIMINAR CLIENTE");
    ...
    private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
        String rutCliente = jTextID.getText();

        if(!(rutCliente.equals(""))){
            if(empresa.buscarCliente(rutCliente)){
                if(empresa.eliminarCliente(rutCliente)){
