...
public class SeleccionAgregarSucursal extends javax.swing.JFrame {
     ...
     */
    public SeleccionAgregarSucursal() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionAgregarSucursal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionAgregarSucursal().setVisible(true);
            }
        });
    }
